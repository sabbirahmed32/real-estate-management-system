! function(t, e) {
    ...
    function a(t, e, s) {
        var a = {};
        return s.isMergeableObject(t) && n(t).forEach((function(e) {
            a[e] = i(t[e], s)
        })), n(e).forEach((function(n) {
            (function(t, e) {
                return r(t, e) && !(Object.hasOwnProperty.call(t, e) && Object.propertyIsEnumerable.call(t, e))
            })(t, n) || (r(t, n) && s.isMergeableObject(e[n]) ? a[n] = function(t, e) {
                if (!e.customMerge) return o;
                var i = e.customMerge(t);
                return "function" == typeof i ? i : o
            }(n, s)(t[n], e[n], s) : a[n] = i(e[n], s))
        })), a
    }
    var o = function(e, n, r) {
            (r = r || {}).arrayMerge = r.arrayMerge || s, r.isMergeableObject = r.isMergeableObject || t, r.cloneUnlessOtherwiseSpecified = i;
            var o = Array.isArray(n);
            return o === Array.isArray(e) ? o ? r.arrayMerge(e, n, r) : a(e, n, r) : i(n, r)
        },
        h = function(t) {
        ...
        l = function(t, e, i, s) {
            ...
            return i && (n[s ? "innerHTML" : "textContent"] = i), e && (n.className = e), n
        },
        c = function(t) {
        ...
        g = {
            on: function(t, e, i, s) {
                ...
                f[n] = {
                    selector: t,
                    handler: i
                }, i._uid = n, t.addEventListener(e, i, s)
            },
    ...
    var v = {
        ...
        _ = function(t, e, i) {
            var s = h(e),
                n = -1 === s.getAttribute("class").indexOf("jvm-region") ? "marker" : "region",
                r = "region" === n,
                a = r ? s.getAttribute("data-code") : s.getAttribute("data-index"),
                o = r ? v.onRegionSelected : v.onMarkerSelected;
            return i && (o = r ? v.onRegionTooltipShow : v.onMarkerTooltipShow), {
                type: n,
                code: a,
                event: o,
                element: r ? t.regions[a].element : t._markers[a].element,
                tooltipText: r ? t._mapData.paths[a].name || "" : t._markers[a].config.name || ""
            }
        };
    ...
    function b(t, e) {
        for (var i = 0; i < e.length; i++) {
            var s = e[i];
            s.enumerable = s.enumerable || !1, s.configurable = !0, "value" in s && (s.writable = !0), Object.defineProperty(t, j(s.key), s)
        }
    }
    ...
    var C = function() {
            ...
            return t.prototype.dispose = function() {
                ...
                for (var t, e = S(Object.getOwnPropertyNames(this)); !(t = e()).done;) {
                    this[t.value] = null
                }
            }, t
        }(),
            ...
            getLabelText: function(t, e) {
                if (e) {
                    if ("function" == typeof e.render) {
                        var i = [];
                        return "marker" === this.constructor.Name && i.push(this.getConfig()), i.push(t), e.render.apply(this, i)
                    }
                    return t
                }
            },
        ...
        O = function(t) {
            function e(e) {
                var i, s = e.map,
                    ...
                    h = e.labelStyle,
                    l = e.labelsGroup;
                (i = t.call(this) || this)._map = s, i.shape = i._createRegion(r, n, a);
                var c = i.getLabelText(n, o);
                if (o && c) {
                    var u = i.shape.getBBox(),
                        p = i.getLabelOffsets(n, o);
    ...
    var A = function(t) {
            function e(e, i) {
                var s;
                return (s = t.call(this) || this)._options = e, s._style = {
                    initial: i
                }, s._draw(), s
            }
            k(e, t);
            ...
            return i.setStyle = function(t, e) {
                ...
                this.shape = s.canvas.createPath(n, this._style, i), this.shape.addClass("jvm-line")
            }, i._getDAttribute = function() {
                var t = this._options,
                    e = t.x1,
                    i = t.y1,
                    s = t.x2,
                    n = t.y2,
                    r = t.curvature;
                return "M" + e + "," + i + this._getQCommand(e, i, s, n, r) + s + "," + n
            }, i._getQCommand = function(t, e, i, s, n) {
                return n ? " Q" + ((t + i) / 2 + n * (s - e)) + "," + ((e + s) / 2 - n * (i - t)) + " " : " "
            }, e
        }(C),
        X = ["curvature"],
        Y = ["curvature"];
    var T = "jvm-",
        E = T + "element " + T + "marker",
        P = T + "element " + T + "label",
        z = function(t) {
            function e(e, i) {
                var s;
                return (s = t.call(this) || this)._options = e, s._style = i, s._labelX = null, s._labelY = null, s._offsets = null, s._isImage = !!i.initial.image, s._draw(), s._options.label && s._drawLabel(), s._isImage && s.updateLabelPosition(), s
            }
            k(e, t);
            var i, s, n, r = e.prototype;
            return r.getConfig = function() {
                return this._options.config
            }, r.updateLabelPosition = function() {
                var t = this._options.map;
                this.label && this.label.set({
                    x: this._labelX * t.scale + this._offsets[0] + t.transX * t.scale + 5 + (this._isImage ? (this.shape.width || 0) / 2 : this.shape.node.r.baseVal.value),
                    y: this._labelY * t.scale + t.transY * this._options.map.scale + this._offsets[1]
                })
            }, r._draw = function() {
                var t = this._options,
                    e = t.index,
                    ...
                    n = t.cx,
                    r = t.cy,
                    a = this._isImage ? "createImage" : "createCircle";
                this.shape = i.canvas[a]({
                    dataIndex: e,
                    cx: n,
                    cy: r
                }, this._style, s), this.shape.addClass(E)
            }, r._drawLabel = function() {
                var t = this._options,
                    e = t.index,
                    i = t.map,
                    s = t.label,
                ...
                this._labelX = r / i.scale - i.transX, this._labelY = a / i.scale - i.transY, this._offsets = h && o.offsets ? o.offsets : this.getLabelOffsets(e, s), this.label = i.canvas.createText({
                    text: l,
                    dataIndex: e,
                    x: this._labelX,
                    y: this._labelY,
                    dy: "0.6ex"
                }, i.params.markerLabelStyle, n), this.label.addClass(P), h && this.updateLabelPosition()
            }, i = e, n = [{
                key: "Name",
                get: function() {
                    return "marker"
                }
            }], (s = null) && b(i.prototype, s), n && b(i, n), Object.defineProperty(i, "prototype", {
                writable: !1
            }), i
        }(C);
    d(z, L);
    var R = function() {
            ...
            return t.prototype.render = function() {
                ...
                if (this._body.innderHTML = "", this._options.title) {
                    var i = l("div", "jvm-legend-title", this._options.title);
                ...
                for (var s = 0; s < e.length; s++) {
                    ...
                    switch (this._series.config.attribute) {
                        case "fill":
                            t = e[s].value, /\.(jpg|gif|png)$/.test(t) ? r.style.background = "url(" + e[s].value + ")" : r.style.background = e[s].value;
                            break;
                        case "stroke":
                            r.style.background = e[s].value;
                            break;
                        case "image":
                            r.style.background = "url(" + ("object" == typeof e[s].value ? e[s].value.url : e[s].value) + ") no-repeat center center", r.style.backgroundSize = "cover"
                    }
                    n.appendChild(r);
                    var a = e[s].label;
                    this._options.labelRender && (a = this._options.labelRender(a));
                    var o = l("div", "jvm-legend-tick-text", a);
                    n.appendChild(o), this._body.appendChild(n)
                }
            }, t
        }(),
        D = function() {
        ...
        I = function() {
            function t(t, e, i) {
                void 0 === t && (t = {}), this._map = i, this._elements = e, this._values = t.values || {}, this.config = t, this.config.attribute = t.attribute || "fill", t.attributes && this.setAttributes(t.attributes), "object" == typeof t.scale && (this.scale = new D(t.scale)), this.config.legend && (this.legend = new R(u({
                    map: this._map,
                    series: this
    ...
    var H = {
        ...
        aea: function(t, e, i) {
            var s = i * this.radDeg,
                ...
                l = Math.cos(n) * Math.cos(n) + 2 * h * Math.sin(n),
                c = h * (o - s),
                u = Math.sqrt(l - 2 * h * Math.sin(a)) / h,
        ...
        lcc: function(t, e, i) {
            var s = i * this.radDeg,
                ...
                a = 45 * this.radDeg,
                o = t * this.radDeg,
                h = Math.log(Math.cos(r) * (1 / Math.cos(a))) / Math.log(Math.tan(Math.PI / 4 + a / 2) * (1 / Math.tan(Math.PI / 4 + r / 2))),
            ...
            return {
                x: c * Math.sin(h * (n - s)) * this.radius,
                y: -(u - c * Math.cos(h * (n - s))) * this.radius
            }
        }
    };
    ...
    var V = {
            _setupContainerEvents: function() {
                ...
                this.params.draggable && (g.on(this.container, "mousemove", (function(i) {
                    ...
                    var e = 75 * ((t.deltaY || -t.wheelDelta || t.detail) >> 10 || 1),
                        ...
                        r = t.pageX - n.left - window.scrollX,
                        a = t.pageY - n.top - window.scrollY,
                        o = Math.pow(1 + s.params.zoomOnScrollSpeed / 1e3, -1.5 * e);
                    s.tooltip && s._tooltip.hide(), s._setScale(s.scale * o, r, a), t.preventDefault()
                }))
            },
            _setupElementEvents: function() {
                var t, e, i, s = this,
                    n = this.container;
                g.on(n, "mousemove", (function(s) {
                    Math.abs(t - s.pageX) + Math.abs(e - s.pageY) > 2 && (i = !0)
                })), g.delegate(n, "mousedown", ".jvm-element", (function(s) {
                    t = s.pageX, e = s.pageY, i = !1
                })), g.delegate(n, "mouseover mouseout", ".jvm-element", (function(t) {
                    var e = _(s, this, !0),
                        i = s.params.showTooltip;
                    "mouseover" === t.type ? (e.element.hover(!0), i && (s._tooltip.text(e.tooltipText), s._emit(e.event, [t, s._tooltip, e.code]), t.defaultPrevented || s._tooltip.show())) : (e.element.hover(!1), i && s._tooltip.hide())
                })), g.delegate(n, "mouseup", ".jvm-element", (function(t) {
                    var e = _(s, this);
                    if (!i && ("region" === e.type && s.params.regionsSelectable || "marker" === e.type && s.params.markersSelectable)) {
                        var n = e.element;
                        s.params[e.type + "sSelectableOne"] && ("region" === e.type ? s.clearSelectedRegions() : s.clearSelectedMarkers()), e.element.isSelected ? n.select(!1) : n.select(!0), s._emit(e.event, [e.code, n.isSelected, "region" === e.type ? s.getSelectedRegions() : s.getSelectedMarkers()])
                    }
                })), g.delegate(n, "click", ".jvm-element", (function(t) {
                    var e = _(s, this),
                        i = e.type,
                        n = e.code;
                    s._emit("region" === i ? v.onRegionClick : v.onMarkerClick, [t, n])
                }))
            },
            _setupZoomButtons: function() {
                var t = this,
                    e = this.params.zoomInButton,
                    i = this.params.zoomOutButton,
                    s = function(t) {
                        return "string" == typeof t ? document.querySelector(t) : t
                    },
                    n = e ? s(e) : l("div", "jvm-zoom-btn jvm-zoomin", "&#43;", !0),
                    r = i ? s(i) : l("div", "jvm-zoom-btn jvm-zoomout", "&#x2212", !0);
                e || this.container.appendChild(n), i || this.container.appendChild(r);
                var a = function(e) {
                    return void 0 === e && (e = !0),
                        function() {
                ...
                g.on(n, "click", a()), g.on(r, "click", a(!1))
            },
            _setupContainerTouchEvents: function() {
                var t, e, i, s, n, r, a, o = this,
                    h = function(h) {
                        var l, c, u, p, d = h.touches;
                        if ("touchstart" == h.type && (a = 0), 1 == d.length) {
                            var f;
                            if (1 == a) u = o.transX, p = o.transY, o.transX -= (i - d[0].pageX) / o.scale, o.transY -= (s - d[0].pageY) / o.scale, null == (f = o._tooltip) || f.hide(), o._applyTransform(), u == o.transX && p == o.transY || h.preventDefault();
                            i = d[0].pageX, s = d[0].pageY
                        } else if (2 == d.length)
                            if (2 == a) {
                                var m;
                                c = Math.sqrt(Math.pow(d[0].pageX - d[1].pageX, 2) + Math.pow(d[0].pageY - d[1].pageY, 2)) / e, o._setScale(t * c, n, r), null == (m = o._tooltip) || m.hide(), h.preventDefault()
                            } else {
                                var g = o.container.getBoundingClientRect();
                                l = {
                                    top: g.top + window.scrollY,
                                    left: g.left + window.scrollX
                                }, n = d[0].pageX > d[1].pageX ? d[1].pageX + (d[0].pageX - d[1].pageX) / 2 : d[0].pageX + (d[1].pageX - d[0].pageX) / 2, r = d[0].pageY > d[1].pageY ? d[1].pageY + (d[0].pageY - d[1].pageY) / 2 : d[0].pageY + (d[1].pageY - d[0].pageY) / 2, n -= l.left, r -= l.top, t = o.scale, e = Math.sqrt(Math.pow(d[0].pageX - d[1].pageX, 2) + Math.pow(d[0].pageY - d[1].pageY, 2))
                            }
                        a = d.length
                    };
            ...
            _createLines: function(t) {
                var e = !1,
                    i = !1,
                    s = this.params.lineStyle,
                    n = s.curvature,
                    r = M(s, X);
                for (var a in t) {
                    for (var o = t[a], h = 0, l = Object.values(this._markers); h < l.length; h++) {
                        var c = l[h].config;
                        c.name === o.from && (e = this.getMarkerPosition(c)), c.name === o.to && (i = this.getMarkerPosition(c))
                    }
                    if (!1 !== e && !1 !== i) {
                        var d = o.style || {},
                            f = d.curvature,
                            m = M(d, Y);
                        this._lines[p(o.from, o.to)] = new A({
                            index: a,
                            map: this,
            ...
            _createMarkers: function(t, e) {
                ...
                var s = function() {
                    var s = t[n],
                        r = i.getMarkerPosition(s),
                        a = s.coords.join(":");
                    if (!r) return 0;
                    if (e) {
                        if (Object.keys(i._markers).filter((function(t) {
                                return i._markers[t]._uid === a
                            })).length) return 0;
                        n = Object.keys(i._markers).length
                    }
                    var o = new z({
                        index: n,
                        map: i,
                        ...
                        config: s,
                        isRecentlyCreated: e
                    }, u(i.params.markerStyle, w({}, s.style || {}), !0));
                    i._markers[n] && i.removeMarkers([n]), i._markers[n] = {
                        _uid: a,
                        config: s,
                        element: o
                    }
            ...
            _createSeries: function() {
                for (var t in this.series = {
                    ...
                    for (var e = 0; e < this.params.series[t].length; e++) this.series[t][e] = new I(this.params.series[t][e], "markers" === t ? this._markers : this.regions, this)
            },
            ...
            setFocus: function(t) {
                ...
                if (t.coords) {
                    var n = this.coordsToPoint(t.coords[0], t.coords[1]),
                        r = this.transX - n.x / this.scale,
                        a = this.transY - n.y / this.scale;
                    return this._setScale(t.scale * this._baseScale, r, a, !0, t.animate)
                }
            },
            updateSize: function() {
            ...
            coordsToPoint: function(t, e) {
                var i = st.maps[this.params.map].projection,
                    s = H[i.type](t, e, i.centralMeridian),
                    n = s.x,
                    r = s.y,
                    a = this.getInsetForPoint(n, r);
                if (!a) return !1;
                var o = a.bbox;
                return n = (n - o[0].x) / (o[1].x - o[0].x) * a.width * this.scale, r = (r - o[0].y) / (o[1].y - o[0].y) * a.height * this.scale, {
                    x: n + this.transX * this.scale + a.left * this.scale,
                    y: r + this.transY * this.scale + a.top * this.scale
                }
            },
            getInsetForPoint: function(t, e) {
                for (var i = st.maps[this.params.map].insets, s = 0; s < i.length; s++) {
                    var n = i[s].bbox,
                        r = n[0],
                        a = n[1];
                    if (t > r.x && t < a.x && e > r.y && e < a.y) return i[s]
                }
            },
            getMarkerPosition: function(t) {
                var e = t.coords;
                return st.maps[this.params.map].projection ? this.coordsToPoint.apply(this, e) : {
            ...
            _repositionLines: function() {
                ...
                Object.values(this._lines).forEach((function(i) {
                    var s = Object.values(t._markers).find((function(t) {
                            return t.config.name === i.getConfig().from
                        })),
                        n = Object.values(t._markers).find((function(t) {
                            return t.config.name === i.getConfig().to
                        }));
                    if (s && n) {
                        var r = t.getMarkerPosition(s.config),
                            a = r.x,
                            o = r.y,
                            h = t.getMarkerPosition(n.config),
                            l = h.x,
                            c = h.y,
                            u = 0 == i._options.curvature ? 0 : i._options.curvature || e,
                            p = (a + l) / 2 + u * (c - o),
                            d = (o + c) / 2 - u * (l - a);
                        i.setStyle({
                            d: "M" + a + "," + o + " Q" + p + "," + d + " " + l + "," + c
        ...
        G = function(t) {
            function e(e, i, s) {
                var n;
                return void 0 === s && (s = {}), (n = t.call(this, e, i) || this).isHovered = !1, n.isSelected = !1, n.style = s, n.style.current = {}, n.updateStyle(), n
            }
            k(e, t);
            var i = e.prototype;
            return i.setStyle = function(t, e) {
        ...
        F = function(t) {
            function e(e) {
                var i;
                return (i = t.call(this, "svg") || this)._container = e, i._defsElement = new B("defs"), i._rootElement = new B("g", {
            ...
            }, i.createPath = function(t, e, i) {
                var s = new G("path", t, e);
                return s.node.setAttribute("fill-rule", "evenodd"), this._add(s, i)
            }, i.createCircle = function(t, e, i) {
                var s = new G("circle", t, e);
                return this._add(s, i)
            }, i.createLine = function(t, e, i) {
                var s = new G("line", t, e);
                return this._add(s, i)
            ...
            return i._bindEventListeners = function() {
                ...
                g.on(this._map.container, "mousemove", (function(e) {
                    if (t._tooltip.classList.contains("active")) {
                        var i, s, n = (i = t._map.container, s = "#jvm-regions-group", Element.prototype.querySelector.call(i, s)).getBoundingClientRect(),
                            r = t._tooltip.getBoundingClientRect(),
                            a = r.height,
                            o = r.width,
                            h = e.clientY <= n.top + a + 5,
                            l = e.pageY - a - 5,
                            c = e.pageX - o - 5;
                        h && (l += a + 5, c -= 10), e.clientX < n.left + o + 5 && (c = e.pageX + 5 + 2, h && (c += 10)), t.css({
                            top: l + "px",
                            left: c + "px"
                        })
                    }
        ...
        $ = Q + "container",
        Z = Q + "markers-group",
        J = Q + "markers-labels-group",
        K = Q + "lines-group",
        tt = Q + "series-container",
        et = tt + " " + Q + "series-h",
        it = tt + " " + Q + "series-v",
        st = function() {
            function t(e) {
            ...
            }, e.setSelectedMarkers = function(t) {
                this._setSelected("_markers", t)
