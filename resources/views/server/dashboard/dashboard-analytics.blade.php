                                   ...
                                   <div class="card-body">
                                        <div class="row align-items-center justify-content-between">
                                             ...
                                             <div class="col-xl-5 col-lg-4 col-md-4">
                                                  <img src="{{asset('assets/images/money.png')}}" alt="" class="img-fluid">
                                             </div>
                                        </div>
                                   </div>
                              </div>
                                        ...
                                        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                             <div class="carousel-inner">
                                                  <div class="carousel-item active">
                                                       <img src="{{asset('assets/images/properties/p-9.jpg')}}" class="d-block w-100 rounded" alt="img-6">
                                                  </div>
                                                  <div class="carousel-item">
                                                       <img src="{{asset('assets/images/properties/p-7.jpg')}}" class="d-block w-100 rounded" alt="img-7">
                                                  </div>
                                                  <div class="carousel-item">
                                                       <img src="{{asset('assets/images/properties/p-8.jpg')}}" class="d-block w-100 rounded" alt="img-5">
                                                  </div>
                                                  <div class="carousel-item">
                                                       <img src="{{asset('assets/images/properties/p-6.jpg')}}" class="d-block w-100 rounded" alt="img-">
                                                  </div>
                                                  <div class="carousel-item">
                                                       <img src="{{asset('assets/images/properties/p-10.jpg')}}" class="d-block w-100 rounded" alt="img-5">
                                                  </div>
                                             </div>
                                             ...
                                             <table class="table align-middle text-nowrap table-hover table-centered mb-0">
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td><img src="{{asset ('assets/images/users/avatar-3.jpg')}}" class="avatar-sm rounded-circle me-2" alt="..."> Theresa T. Brose</td>
                                                            <td>IN-3728</td>
                                                            <td> 03 Dec, 2023</td>
                                                            <td> $78,483 </td>
                                                            <td> Visa </td>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td><img src="{{asset('assets/images/users/avatar-4.jpg')}}" class="avatar-sm rounded-circle me-2" alt="..."> James L. Erickson</td>
                                                            <td>IN-8265</td>
                                                            <td> 28 Sep, 2023 </td>
                                                            <td> $83,644 </td>
                                                            <td> Paypal </td>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td><img src="{{asset('assets/images/users/avatar-5.jpg')}}" class="avatar-sm rounded-circle me-2" alt="..."> Lily W. Wilson</td>
                                                            <td>IN-9025</td>
                                                            <td>10 Aug, 2023</td>
                                                            <td> $94,305 </td>
                                                            <td> Mastercard</td>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td><img src="{{asset('assets/images/users/avatar-6.jpg')}}" class="avatar-sm rounded-circle me-2" alt="..."> Sarah M. Brooks</td>
                                                            <td>IN-8945</td>
                                                            <td> 22 May, 2023 </td>
                                                            <td> $42.561</td>
                                                            <td> Visa</td>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td><img src="{{asset('assets/images/users/avatar-7.jpg')}}" class="avatar-sm rounded-circle me-2" alt="..."> Joe K. Hall</td>
                                                            <td>IN-0987</td>
                                                            <td>15 Mar, 2023
                                                            </td>
                                                            <td>$25,671 </td>
